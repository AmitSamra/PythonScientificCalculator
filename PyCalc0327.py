...
def choose_op():
    ...
    if op == 1:
        ...
        addend1 = Calculator.enter_num()
        print('Enter the second addend: ')
        addend2 = Calculator.enter_num()
        ...
        minuend = Calculator.enter_num()
        print('Enter the subtrahend: ')
        subtrahend = Calculator.enter_num()
        ...
        a = Calculator.enter_num()
        print('Enter the second factor: ')
        b = Calculator.enter_num()
        ...
        dividend = Calculator.enter_num()
        print('Enter the divisor: ')
        divisor = Calculator.enter_num()
        if divisor == 0:
            print('ERROR')
            return None
        else:
        ...
        base = Calculator.enter_num()
        result = Calculator.square(base)
        return result
        ...
        exponent = Calculator.enter_num()
        result = Calculator.exp(base,exponent)
        return result

    elif op == 7:
        print('Square Root')
        print('Enter a radicand: ')
        radicand = Calculator.enter_num()
        result = Calculator.square_root(radicand)
        return result

    elif op == 8:
        print('Inverse')
        num = Calculator.enter_num()
        result = Calculator.inv(num)
        return result
        ...
        if dr == 1:
            ...
            num = Calculator.enter_num()
            result = Calculator.sine(math.degrees(num))
            return result
        ...
        if dr == 1:
            ...
            num = Calculator.enter_num()
            result = Calculator.cosine(math.degrees(num))
            return result
        ...
        if dr == 1:
            ...
            num = Calculator.enter_num()
            result = Calculator.tangent(math.degrees(num))
            return result
        ...
        num = Calculator.enter_num()
        result = Calculator.switch_sign(num)
        return result
        ...
        if dr == 1:
            ...
            num = Calculator.enter_num()
            result = Calculator.invSin(num)
            return result
        elif dr == 2:
            print('Enter an angle in degrees to find arcSin(angle): ')
            num = Calculator.enter_num()
            result = Calculator.invSin(math.degrees(num))
            return result
        elif dr == 2:
        ...
        if dr == 1:
            ...
            num = Calculator.enter_num()
            result = Calculator.invCos(num)
            return result
        elif dr == 2:
            print('Enter an angle in degrees to find arcCos(angle): ')
            num = enter_num()
            result = Calculator.invCos(math.degrees(num))
            return result
        elif dr == 2:
        ...
        if dr == 1:
            ...
            num = Calculator.enter_num()
            result = Calculator.invTan(num)
            return result
        elif dr == 2:
            print('Enter an angle in degrees to find arcTan(angle): ')
            num = Calculator.enter_num()
            result = Calculator.invTan(math.degrees(num))
            return result
        elif dr == 2:
        ...
        num = Calculator.enter_num()
        result = Calculator.log_base_10(num)
        return result
        ...
        num = Calculator.enter_num()
        result = Calculator.inv_log_10(num)
        return result
        ...
        num = Calculator.enter_num()
        result = Calculator.log_base_e(num)
        return result
        ...
        num = Calculator.enter_num()
        result = Calculator.inv_log_e(num)
        return result

    elif op == 21:
        print(' Log of n base b')
        print('Enter a number: ')
        n = Calculator.enter_num()
        print('Enter a base: ')
        b = Calculator.enter_num()
        result = Calculator.log_base_y(n,b)
        return result
...
def choose_small_op():
    ...
    if op == 1:
        ...
        print('Enter the second addend: ')
        addend2 = Calculator.enter_num()
        result = Calculator.add2(addend2)
        return result
        ...
        print('Enter the subtrahend: ')
        subtrahend = Calculator.enter_num()
        result = Calculator.subtract2(subtrahend)
        return result
        ...
        print('Enter the divisor: ')
        divisor = Calculator.enter_num()
        result = Calculator.divide2(divisor)
        return result

    elif op == 5:
        print('Square')
        result = Calculator.square2(main_result)
        return result
        ...
        print('Enter the exponent')
        exponent = Calculator.enter_num()
        result = Calculator.exp2(exponent)
        return result

    elif op == 7:
        print('Square Root')
        result = Calculator.square_root2(main_result)
        return result

    elif op == 8:
        print('Inverse')
        #num = enter_num()
        result = Calculator.inv2(main_result)
        return result
